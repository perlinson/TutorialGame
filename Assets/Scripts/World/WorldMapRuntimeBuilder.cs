...
public static class WorldMapRuntimeBuilder
{
    public static WorldMapController Create()
    {
        ...
        var titlePanel = CreatePanel("TitlePanel", root.transform, new Vector2(70f, -50f), new Vector2(1780f, 170f), new Color(0.08f, 0.1f, 0.12f, 0.84f));
        ...
        heroSummary.verticalOverflow = VerticalWrapMode.Overflow;
        ...
        resourceSummary.horizontalOverflow = HorizontalWrapMode.Wrap;
        resourceSummary.verticalOverflow = VerticalWrapMode.Overflow;
        ...
        bagSummary.horizontalOverflow = HorizontalWrapMode.Wrap;
        bagSummary.verticalOverflow = VerticalWrapMode.Overflow;
        ...
        var mapPanel = CreatePanel("MapPanel", root.transform, new Vector2(70f, -260f), new Vector2(1180f, 730f), new Color(0.07f, 0.09f, 0.1f, 0.74f));
        ...
        var detailPanel = CreatePanel("DetailPanel", root.transform, new Vector2(-70f, -260f), new Vector2(530f, 730f), new Color(0.08f, 0.1f, 0.12f, 0.82f));
        ...
        regionBody.horizontalOverflow = HorizontalWrapMode.Wrap;
        regionBody.verticalOverflow = VerticalWrapMode.Overflow;
        ...
        regionStatus.horizontalOverflow = HorizontalWrapMode.Wrap;
        regionStatus.verticalOverflow = VerticalWrapMode.Overflow;
        ...
        taskSummary.horizontalOverflow = HorizontalWrapMode.Wrap;
        taskSummary.verticalOverflow = VerticalWrapMode.Overflow;
        ...
        var hintPanel = CreatePanel("HintPanel", root.transform, new Vector2(70f, 40f), new Vector2(1780f, 44f), new Color(0.07f, 0.08f, 0.09f, 0.82f));
        ...
        var inventoryPanel = CreatePanel("InventoryPanel", root.transform, Vector2.zero, new Vector2(820f, 660f), new Color(0.07f, 0.08f, 0.09f, 0.96f));
        ...
        inventoryDetail.horizontalOverflow = HorizontalWrapMode.Wrap;
        inventoryDetail.verticalOverflow = VerticalWrapMode.Overflow;
        ...
        var workshopPanel = CreatePanel("WorkshopPanel", root.transform, Vector2.zero, new Vector2(920f, 680f), new Color(0.07f, 0.08f, 0.09f, 0.96f));
        ...
        workshopSummary.horizontalOverflow = HorizontalWrapMode.Wrap;
        workshopSummary.verticalOverflow = VerticalWrapMode.Overflow;
        ...
        var sectPanel = CreatePanel("SectPanel", root.transform, Vector2.zero, Vector2.zero, new Color(0.03f, 0.04f, 0.05f, 0.985f));
        Stretch(sectPanel);
        ...
        sectDescription.horizontalOverflow = HorizontalWrapMode.Wrap;
        sectDescription.verticalOverflow = VerticalWrapMode.Overflow;
    ...
    private static Button CreateButton(string name, Transform parent, Vector2 anchoredPosition, Vector2 size, string label, int fontSize = 20)
    {
        ...
        rect.sizeDelta = size;
        SetAnchors(rect, new Vector2(0f, 1f), new Vector2(0f, 1f), new Vector2(0f, 1f));
        root.GetComponent<Image>().color = new Color(0.23f, 0.19f, 0.12f, 0.96f);

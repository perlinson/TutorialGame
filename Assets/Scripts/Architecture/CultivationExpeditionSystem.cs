...
public sealed class CultivationExpeditionSystem : AbstractSystem
{
    ...
    private static void ApplyStress(ExpeditionTraversalContext context, ExpeditionTraversalResult result, int amount)
    {
        var mindResult = CultivationApp.ApplyTraversalMindStress(context, amount);

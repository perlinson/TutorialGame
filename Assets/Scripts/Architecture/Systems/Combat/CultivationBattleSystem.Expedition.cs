...
public sealed partial class CultivationBattleSystem
{
        ...
        List<SaveItemStack> pendingItemRewards)
    {
        ...
        var clearLoot = rewardSystem.BuildClearLoot(region, saveData);
        rewardSystem.MergeLoot(pendingItemRewards, clearLoot);
        var clearProgress = taskSystem.RecordProgress(saveData, new TaskProgressSignal
        {
        ...
        var bankResult = rewardSystem.BankPendingLoot(saveData, pendingItemRewards);

...
namespace QFramework
{
    ...
    public class AudioManager : MonoBehaviour, ISingleton,IController
    {
        ...
        public void OnSingletonInit()
        {
            ...
            MusicPlayer = AudioPlayer.Allocate(AudioKit.Settings.MusicVolume).AssignBus(CultivationAudioBus.Music);
            MusicPlayer.UsedCache = false;
            MusicPlayer.IsLoop = true;
            VoicePlayer = AudioPlayer.Allocate(AudioKit.Settings.VoiceVolume).AssignBus(CultivationAudioBus.Voice);
        ...
        public static void PlayVoiceOnce(string voiceName)
        {
            ...
            unit.AssignBus(CultivationAudioBus.Voice);

...
namespace QFramework
{
    public class AudioPlayer : IPoolable, IPoolType, IAudioKitOnFinish, IAudioKitOnRelease
    {
        ...
        private CultivationAudioBus mAudioBus = CultivationAudioBus.Sfx;
        ...
        internal static AudioPlayer Allocate(BindableProperty<float> volume)
        {
            ...
            player.mPitch = 1.0f;
            player.mAudioBus = CultivationAudioBus.Sfx;
        ...
        public AudioPlayer AssignBus(CultivationAudioBus audioBus)
        {
            mAudioBus = audioBus;
            RouteAudioSource();
            return this;
        ...
        void RouteAudioSource()
        {
            if (mAudioSourceController != null && mAudioSourceController.AudioSource != null)
            {
                CultivationAudioMixerRouter.Route(mAudioSourceController.AudioSource, mAudioBus);
            }
        }
